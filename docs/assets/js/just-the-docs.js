...
{"0": {
    ...
    "url": "http://localhost:4000/usb_apps_multi_controller/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "Host MSD Dual Example",
    "title": "Host MSD Dual Example (host_msd_dual)",
    "content": "This application demonstrates the ability of the MPLAB Harmony USB Stack to support multiple USB Host operation on a PIC32 microcontroller with two USB Controllers. ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/host_msd_dual/readme.html#host-msd-dual-example-host_msd_dual",
    "relUrl": "/apps/host_msd_dual/readme.html#host-msd-dual-example-host_msd_dual"
  },"2": {
    "doc": "Host MSD Dual Example",
    "title": "Description",
    "content": "This application demonstrates Multiple USB Host operation on a PIC32 microcontroller with two USB Controllers. Both the USB peripherals operate in USB MSD Host mode. This demonstrates capability of Harmony USB stack to work with multiple USB controllers. ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/host_msd_dual/readme.html#description",
    "relUrl": "/apps/host_msd_dual/readme.html#description"
  },"3": {
    "doc": "Host MSD Dual Example",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is usb_apps_multi_controller/apps/host_msd_dual. Following table gives the details of project configurations, target device used, hardware and its IDE. Open the project using the respective IDE and build it. | Project Name | IDE | Target Device | Hardware / Configuration | . | pic32mk_gp_db.X | MPLABX | PIC32MK1024GPE100 | PIC32MK General Purpose (GP) Development Board | . | pic32mk_mcm_curiosity_pro.X | MPLABX | PIC32MK1024MCM100 | PIC32MK MCM Curiosity Pro Development Board | . ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/host_msd_dual/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/host_msd_dual/readme.html#downloading-and-building-the-application"
  },"4": {
    "doc": "Host MSD Dual Example",
    "title": " Configuring the Hardware",
    "content": "PIC32MK General Purpose (GP) Development Board . | Switch S4 should be set to the Device position. | Jumper J28 must be shorted. | USB Micro B Connector J2 must be connected to a USB Host for powering the board. | LED 1 on the demonstration board will illuminate to indicate completion of the file transfer. | USB Flash drives should be attached to Connector J15 (Type C connector) and J14 (Type A connector) after programming the microcontroller. | . PIC32MK MCM Curiosity Pro Development Board . | Switch S200 should be set to the Device position. | Jumper J204 must be shorted. | USB Micro B Connector J203 must be connected to a USB Host for powering the board. | LED 1 on the demonstration board will illuminate to indicate completion of the file transfer. | USB Flash drives should be attached to Connector J202 (Type C connector) and J201 (Type A connector) after programming the microcontroller. | . ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/host_msd_dual/readme.html#-configuring-the-hardware",
    "relUrl": "/apps/host_msd_dual/readme.html#-configuring-the-hardware"
  },"5": {
    "doc": "Host MSD Dual Example",
    "title": "Running the Application",
    "content": "This application demonstrates the capability of a PIC32 microcontroller and the MPLAB Harmony USB Host stack to work with two USB Controllers in an application. The MPLAB Harmony USB Stack is capable of handling multiple USB controllers. The application uses the USB Host_layer, MSD class driver, and the MPLAB Harmony File System Framework to enumerate a USB Flash drive and to write a file to it. Do the following to run this demonstration: . | Open the project with appropriate IDE. Compile the project and program the target device. | Two USB Flash drives are needed to run this demo. | With the code running, attach a USB Flash drive with a file file.txt in it to one of the Host connector on the board. | Connect another USB Flash drive to other Host connector on the board. Ensure this flash drive does not contain any file named newfile.txt. | The application will copy the file file.txt from the drive containing this file to the other drive. The copied file will be renamed as newfile.txt. LED2 on the demonstration board will illuminate to indicate completion of the file transfer. | Disconnect the drives and confirm demonstration success by inserting them into a personal computer and verifying the file transfer completed as expected. | . ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/host_msd_dual/readme.html#running-the-application",
    "relUrl": "/apps/host_msd_dual/readme.html#running-the-application"
  },"6": {
    "doc": "Host MSD Dual Example",
    "title": "Host MSD Dual Example",
    "content": ". ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/host_msd_dual/readme.html",
    "relUrl": "/apps/host_msd_dual/readme.html"
  },"7": {
    "doc": "Dual CDC Device Example",
    "title": "Dual CDC Device Example (device_dual_cdc)",
    "content": "This application demonstrates the ability of the MPLAB Harmony USB Stack to support multiple USB Device operation on a PIC32 microcontroller with two USB Controllers. ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_dual_cdc/readme.html#dual-cdc-device-example-device_dual_cdc",
    "relUrl": "/apps/device_dual_cdc/readme.html#dual-cdc-device-example-device_dual_cdc"
  },"8": {
    "doc": "Dual CDC Device Example",
    "title": "Description",
    "content": "This application demonstrates Multiple USB Device operation on a PIC32 microcontroller with two USB Controllers. Both the USB peripherals operate in USB CDC Device mode. This demonstrates capability of Harmony USB stack to work with multiple USB controllers. ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_dual_cdc/readme.html#description",
    "relUrl": "/apps/device_dual_cdc/readme.html#description"
  },"9": {
    "doc": "Dual CDC Device Example",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is usb_apps_multi_controller/apps/device_dual_cdc. Following table gives the details of project configurations, target device used, hardware and its IDE. Open the project using the respective IDE and build it. | Project Name | IDE | Target Device | Hardware / Configuration | . | pic32mk_gp_db.X | MPLABX | PIC32MK1024GPE100 | PIC32MK General Purpose (GP) Development Board | . | pic32mk_mcm_curiosity_pro.X | MPLABX | PIC32MK1024MCM100 | PIC32MK MCM Curiosity Pro Development Board | . ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_dual_cdc/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/device_dual_cdc/readme.html#downloading-and-building-the-application"
  },"10": {
    "doc": "Dual CDC Device Example",
    "title": " Configuring the Hardware",
    "content": "PIC32MK General Purpose (GP) Development Board . | Switch S4 should be set to the Device position. | Jumper J28 must be removed. | USB Micro B Connector J12 must be connected to a USB Host for powering the board. | Use the USB connectors on the board to connect the USB Device to the USB Host PC. | J13 - USB Peripheral 1 (USB Micro B connector located on the bottom side of the board) | J15 - USB Peripheral 2 (USB Type C connector) | . | Following LEDs indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | LED1 - USB Peripheral 1 (USB Micro B connector - J13) | LED2 - USB Peripheral 2 (USB Type C connector - J15) | . | Press switch to trigger communication from the USB Device to the USB Host. | S1 - USB Peripheral 1 (USB Micro B connector - J13) | S2 - USB Peripheral 2 (USB Type C connector - J15) | . | . PIC32MK MCM Curiosity Pro Development Board . | Switch S200 should be set to the Device position. | Jumper J204 must be removed. | USB Micro B Connector J203 must be connected to a USB Host for powering the board. | Use the USB connectors on the board to connect the USB Device to the USB Host PC. | J200 - USB Peripheral 1 (USB Micro B connector located on the bottom side of the board) | J202 - USB Peripheral 2 (USB Type C connector) | . | Following LEDs indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | LED1 - USB Peripheral 1 (USB Micro B connector - J200) | LED2 - USB Peripheral 2 (USB Type C connector - J202) | . | Press switch to trigger communication from the USB Device to the USB Host. | SW1 - USB Peripheral 1 (USB Micro B connector - J200) | SW2 - USB Peripheral 2 (USB Type C connector - J202) | . | . ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_dual_cdc/readme.html#-configuring-the-hardware",
    "relUrl": "/apps/device_dual_cdc/readme.html#-configuring-the-hardware"
  },"11": {
    "doc": "Dual CDC Device Example",
    "title": "Running the Application",
    "content": "This application demonstrates dual USB Device operation on a PIC32 microcontroller with two USB Controllers. The MPLAB Harmony USB Stack is capable of handling multiple USB controllers. In this demonstration, both of the USB controllers act as CDC devices. This demonstration allows the each controller on the PIC32 to appear like a serial (COM) port to the host. Do the following to run this demonstration: . | Open the project with appropriate IDE. Compile the project and program the target device. | Attach both USB connectors J15 and J13 to a USB Host. Refer to Configuring the Hardware for details. | The CDC Device application is same as cdc_com_port_single demo. Refer to local documentation from usb_apps_device/apps/cdc_com_port_single. The documentation is also available in the github path usb_apps_device/apps/cdc_com_port_single. | . ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_dual_cdc/readme.html#running-the-application",
    "relUrl": "/apps/device_dual_cdc/readme.html#running-the-application"
  },"12": {
    "doc": "Dual CDC Device Example",
    "title": "Dual CDC Device Example",
    "content": ". ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_dual_cdc/readme.html",
    "relUrl": "/apps/device_dual_cdc/readme.html"
  },"13": {
    "doc": "CDC Device and MSD Host Example",
    "title": "CDC Device and MSD Host Example (device_cdc_host_msd)",
    "content": "This application demonstrates the ability of the MPLAB Harmony USB Stack to support USB Device and Host operation on a PIC32 microcontroller with two USB Controllers. ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_cdc_host_msd/readme.html#cdc-device-and-msd-host-example-device_cdc_host_msd",
    "relUrl": "/apps/device_cdc_host_msd/readme.html#cdc-device-and-msd-host-example-device_cdc_host_msd"
  },"14": {
    "doc": "CDC Device and MSD Host Example",
    "title": "Description",
    ...
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_cdc_host_msd/readme.html#description",
    "relUrl": "/apps/device_cdc_host_msd/readme.html#description"
  },"15": {
    "doc": "CDC Device and MSD Host Example",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is usb_apps_multi_controller/apps/device_cdc_host_msd. Following table gives the details of project configurations, target device used, hardware and its IDE. Open the project using the respective IDE and build it. | Project Name | IDE | Target Device | Hardware / Configuration | . | pic32mk_gp_db.X | MPLABX | PIC32MK1024GPE100 | PIC32MK General Purpose (GP) Development Board | . | pic32mk_mcm_curiosity_pro.X | MPLABX | PIC32MK1024MCM100 | PIC32MK MCM Curiosity Pro Development Board | . ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_cdc_host_msd/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/device_cdc_host_msd/readme.html#downloading-and-building-the-application"
  },"16": {
    "doc": "CDC Device and MSD Host Example",
    "title": " Configuring the Hardware",
    "content": "PIC32MK General Purpose (GP) Development Board . | Switch S4 should be set to the Device position. | Jumper J28 must be removed. | USB Micro B Connector J12 must be connected to a USB Host for powering the board. | USB1 Peripheral (Type A connector - J14) operates in USB Host mode. | USB Flash drives should be attached to J14 (Type A connector) | LED 2 on the demonstration board will illuminate to indicate completion of the file transfer. | . | USB2 Peripheral operates (Type C connector - J15) operates in USB Device mode . | Connect J15 to a Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press S1 to trigger communication from the USB Device to the USB Host. | . | . PIC32MK MCM Curiosity Pro Development Board . | Switch S200 should be set to the Device position. | Jumper J204 must be removed. | USB Micro B Connector J203 must be connected to a USB Host for powering the board. | USB1 Peripheral (Type A connector - J201) operates in USB Host mode. | USB Flash drives should be attached to J201 (Type A connector) | LED 2 on the demonstration board will illuminate to indicate completion of the file transfer. | . | USB2 Peripheral operates (Type C connector - J202) operates in USB Device mode . | Connect J202 to a Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press SW1 to trigger communication from the USB Device to the USB Host. | . | . ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_cdc_host_msd/readme.html#-configuring-the-hardware",
    "relUrl": "/apps/device_cdc_host_msd/readme.html#-configuring-the-hardware"
  },"17": {
    "doc": "CDC Device and MSD Host Example",
    "title": "Running the Application",
    "content": "This application demonstrates the capability of a PIC32 microcontroller and the MPLAB Harmony USB Host stack to work with two USB Controllers in an application. This application operates USB1 controller on the PIC32MK in USB Host mode and USB2 Controller in USB Device mode. USB1 controller on the PIC32 to operate as USB Host MSD and USB2 peripheral to appear like a serial (COM) port to the host. Do the following to run this demonstration: . | Open the project with appropriate IDE. Compile the project and program the target device. | Attach a USB Flash drive to the Host connector and Connect USB Device connector to a USB Host. Refer to Configuring the Hardware for details. | The CDC Device application is same as cdc_com_port_single demo. Refer to local documentation from usb_apps_device/apps/cdc_com_port_single. The documentation is also available in the github path usb_apps_device/apps/cdc_com_port_single. | The MSD Host application is same as msd_basic host demo. Refer to local documentation from usb_apps_host/apps/msd_basic. The documentation is also available in the github path usb_apps_host/apps/msd_basic. | . Note: The PC driver needed for USB device should be used from usb_apps_multi_controller/apps/device_cdc_host_msd\\bin\\GenericHIDSimpleDemo_Composite_HID+MSD_Demo_only_PID_0x0054.exe. To launch the application, double click the executable GenericHIDSimpleDemo_Composite_HID+MSD_Demo_only_PID_0x0054.exe. ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_cdc_host_msd/readme.html#running-the-application",
    "relUrl": "/apps/device_cdc_host_msd/readme.html#running-the-application"
  },"18": {
    "doc": "CDC Device and MSD Host Example",
    "title": "CDC Device and MSD Host Example",
    "content": ". ",
    "url": "http://localhost:4000/usb_apps_multi_controller/apps/device_cdc_host_msd/readme.html",
    "relUrl": "/apps/device_cdc_host_msd/readme.html"
  },"19": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![Microchip logo](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_logo.png) ![Harmony logo small](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_mplab_harmony_logo_small.png) # Microchip MPLAB® Harmony 3 Release Notes ## Harmony 3 USB Multi-Controller application examples v3.3.0 ### Development kit and demo application support The following table provides the number of USB Multi-Controller examples available for different development kits. | Development Kits | MPLAB X Applications | IAR Applications | ----------------- | ------------------- | ---------------- | [PIC32MK General Purpose (GP) Development Board](https://www.microchip.com/developmenttools/ProductDetails/dm320106) | 3 | 0 | [PIC32MK MCM Curiosity Pro Development Board](https://www.microchip.com/Developmenttools/ProductDetails/EV31E34A) | 3 | 0 | ### New Features and Enhancements - Added MPLAB® Code Configurator (MCC) configurations for all demonstration configurations. - Updated CDC Driver packages. ### Known Issues - None ### Development Tools - [MPLAB® X IDE v6.00](https://www.microchip.com/mplab/mplab-x-ide) - [MPLAB® XC32 C/C++ Compiler v4.00](https://www.microchip.com/mplab/compilers) - [IAR Embedded Workbench® for ARM® v8.5](https://www.iar.com/iar-embedded-workbench/#!?architecture=Arm) - MPLAB® X IDE plug-ins:- MPLAB® Code Configurator (MCC) v5.1.1 or above ## Harmony 3 USB Multi-Controller application examples v3.2.0 ### Bug fixes - [MPLAB® Discover portal](https://mplab-discover.microchip.com/) metadata for all demonstration application configurations have been updated. ### New Features and Enhancements - None ### Known Issues - None ### Development Tools - Same as v3.1.0 ## Harmony 3 USB Multi-Controller application examples v3.1.1 ### Bug fixes - [MPLAB® Discover portal](https://mplab-discover.microchip.com/) metadata for all demonstration application configurations have been updated. ### New Features and Enhancements - None ### Known Issues - None ### Development Tools - Same as v3.1.0 ## Harmony 3 USB Multi-Controller application examples v3.1.0 ### Development kit and demo application support The following table provides the number of USB Multi-Controller examples available for different development kits. | Development Kits | MPLAB X Applications | IAR Applications | ----------------- | ------------------- | ---------------- | [PIC32MK General Purpose (GP) Development Board](https://www.microchip.com/developmenttools/ProductDetails/dm320106) | 3 | 0 | [PIC32MK MCM Curiosity Pro Development Board](https://www.microchip.com/Developmenttools/ProductDetails/EV31E34A) | 3 | 0 | ### New Features and Enhancements - All demonstration applications are regnerated with MPLAB® Harmony USB v3.8.0 ### Known Issues - None ### Development Tools - [MPLAB® X IDE v5.50](https://www.microchip.com/mplab/mplab-x-ide) - [MPLAB® XC32 C/C++ Compiler v3.00](https://www.microchip.com/mplab/compilers) - MPLAB® X IDE plug-ins:- MPLAB® Harmony 3 Launcher v3.6.4 or above ## Harmony 3 USB Multi-Controller application examples v3.0.0 - Applications migrated from USB repository to this new application repository for USB Multi-Controller examples ### Development kit and demo application support Following table provides number of USB Multi-Controller examples available for different development kits. | Development Kits | MPLABX applications | IAR applications | ----------------- | ------------------- | ---------------- | [PIC32MK General Purpose (GP) Development Board](https://www.microchip.com/developmenttools/ProductDetails/dm320106) | 3 | 0 | [PIC32MK MCM Curiosity Pro Development Board](https://www.microchip.com/Developmenttools/ProductDetails/EV31E34A) | 3 | 0 | ### New Features New features added in this release are as follows: - Applications migrated from USB repository to this new application repository for USB Multi-Controller examples ### Known Issues The current known issues are as follows: - None ### Development Tools - [MPLAB® X IDE v5.45](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - MPLAB® Harmony Configurator (MHC) v3.6.0 - [MPLAB® XC32 C/C++ Compiler v2.50](https://www.microchip.com/mplab/compilers) - [KEIL MDK v5.30 or above](https://www2.keil.com/mdk5) - [IAR Embedded workbench for ARM v8.50 or above](https://www.iar.com/iar-embedded-workbench/#!?architecture=Arm) ",
    "url": "http://localhost:4000/usb_apps_multi_controller/release_notes.html",
    "relUrl": "/release_notes.html"
  },"20": {
    "doc": "Harmony 3 USB Multi-Controller application examples",
    "title": "Harmony 3 USB Multi-Controller application examples",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 USB Multi-Controller application examples MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 USB Multi-Controller application examples. - [Release Notes](/usb_apps_multi_controller/release_notes.html) - [MPLAB® Harmony License](/usb_apps_multi_controller/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/usb_apps_multi_controller) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). # Contents Summary | Folder | Description | --- | --- | apps | Contains Harmony 3 USB Multi-Controller application examples | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/usb_apps_multi_controller/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of USB Multi Controller capabilities. | Name | Description | ------------------------- | ---------------------- | CDC Device and MSD Host | This application demonstrates USB Device and Host operation on a PIC32 microcontroller with two USB Controllers. One USB peripheral operates in USB Device mode and other peripheral operates in USB Host mode. This demonstrates capability of Harmony USB stack to work with multiple USB controllers. | Dual CDC Device | This application demonstrates the ability of the MPLAB Harmony USB Stack to support multiple USB Device operation on a PIC32 microcontroller with two USB Controllers. | Host MSD Dual | This application demonstrates Multiple USB Host operation on a PIC32 microcontroller with two USB Controllers. Both the USB peripherals operate in USB MSD Host mode. This demonstrates capability of Harmony USB stack to work with multiple USB controllers. | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/usb_apps_multi_controller/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/usb_apps_multi_controller.svg)](https://github.com/Microchip-MPLAB-Harmony/usb_apps_multi_controller/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/usb_apps_multi_controller.svg)](https://github.com/Microchip-MPLAB-Harmony/usb_apps_multi_controller/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/usb_apps_multi_controller.svg)](https://github.com/Microchip-MPLAB-Harmony/usb_apps_multi_controller/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/usb_apps_multi_controller.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/usb_apps_multi_controller.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/usb_apps_multi_controller.svg?style=social)]() ",
    "url": "http://localhost:4000/usb_apps_multi_controller/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "usb_apps_multi_controller";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 USB Multi Controller application examples";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/usb_apps_multi_controller/assets/css/just-the-docs-' + theme + '.css');
}
